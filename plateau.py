class Plateau:
	...
	def validerPiece(self, pieceEnCours, joueur):
		...
		if (self.verifierPlacement(pieceEnCours, joueur) == True):
			...
			joueur.removePiece(pieceEnCours)
		...
		for i in range(len(lastPiece.matrice)):
			for j in range(len(lastPiece.matrice)):
				if (lastPiece.matrice[i][j] != ' ') and (copyTableauJeu[lastPiece.positionX+i][lastPiece.positionY+j] == ' '):
					...
					if ((copyTableauJeu[lastPiece.positionX+i+1][lastPiece.positionY+j] != lastPiece.couleur) or (str(lastPiece.positionX+i+1)+";"+str(lastPiece.positionY+j) in listSquarePlacer)) and ((copyTableauJeu[lastPiece.positionX+i-1][lastPiece.positionY+j] != lastPiece.couleur) or (str(lastPiece.positionX+i-1)+";"+str(lastPiece.positionY+j) in listSquarePlacer)) and ((copyTableauJeu[lastPiece.positionX+i][lastPiece.positionY+j+1] != lastPiece.couleur) or (str(lastPiece.positionX+i)+";"+str(lastPiece.positionY+j+1) in listSquarePlacer)) and ((copyTableauJeu[lastPiece.positionX+i][lastPiece.positionY+j-1] != lastPiece.couleur) or (str(lastPiece.positionX+i)+";"+str(lastPiece.positionY+j-1) in listSquarePlacer)):
						print("1eme TRUE")
						if ((copyTableauJeu[lastPiece.positionX+i+1][lastPiece.positionY+j+1] == lastPiece.couleur) or (str(lastPiece.positionX+i+1)+";"+str(lastPiece.positionY+j+1) in listSquarePlacer)) or ((copyTableauJeu[lastPiece.positionX+i-1][lastPiece.positionY+j-1] == lastPiece.couleur) or (str(lastPiece.positionX+i-1)+";"+str(lastPiece.positionY+j-1) in listSquarePlacer)) or ((copyTableauJeu[lastPiece.positionX+i-1][lastPiece.positionY+j+1] == lastPiece.couleur) or (str(lastPiece.positionX+i-1)+";"+str(lastPiece.positionY+j+1) in listSquarePlacer)) or ((copyTableauJeu[lastPiece.positionX+i+1][lastPiece.positionY+j-1] == lastPiece.couleur) or (str(lastPiece.positionX+i+1)+";"+str(lastPiece.positionY+j-1) in listSquarePlacer)):
							print("2eme TRUE")
							return True
						else:
							return False
