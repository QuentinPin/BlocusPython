...
class FactoryPiece:
	def createAllPiece(couleur):
		...
		listeAllPiece.append(Piece(Piece1, couleur))
		listeAllPiece.append(Piece(Piece2, couleur))
		listeAllPiece.append(Piece(Piece3, couleur))
		listeAllPiece.append(Piece(Piece4, couleur))
		listeAllPiece.append(Piece(Piece5, couleur))
		listeAllPiece.append(Piece(Piece6, couleur))
		listeAllPiece.append(Piece(Piece7, couleur))
		listeAllPiece.append(Piece(Piece8, couleur))
		listeAllPiece.append(Piece(Piece9, couleur))
		listeAllPiece.append(Piece(Piece10, couleur))
		listeAllPiece.append(Piece(Piece11, couleur))
		listeAllPiece.append(Piece(Piece12, couleur))
		listeAllPiece.append(Piece(Piece13, couleur))
		listeAllPiece.append(Piece(Piece14, couleur))
		listeAllPiece.append(Piece(Piece15, couleur))
		listeAllPiece.append(Piece(Piece16, couleur))
		listeAllPiece.append(Piece(Piece17, couleur))
		listeAllPiece.append(Piece(Piece18, couleur))
		listeAllPiece.append(Piece(Piece19, couleur))
		listeAllPiece.append(Piece(Piece20, couleur))
		listeAllPiece.append(Piece(Piece21, couleur))
