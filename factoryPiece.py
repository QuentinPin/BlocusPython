...
class FactoryPiece:
	def createAllPiece(couleur):
		...
		listeAllPiece.append(Piece(Piece1, 1))
		listeAllPiece.append(Piece(Piece2, 2))
		listeAllPiece.append(Piece(Piece3, 3))
		listeAllPiece.append(Piece(Piece4, 4))
		listeAllPiece.append(Piece(Piece5, 5))
		listeAllPiece.append(Piece(Piece6, 6))
		listeAllPiece.append(Piece(Piece7, 7))
		listeAllPiece.append(Piece(Piece8, 8))
		listeAllPiece.append(Piece(Piece9, 9))
		listeAllPiece.append(Piece(Piece10, 10))
		listeAllPiece.append(Piece(Piece11, 11))
		listeAllPiece.append(Piece(Piece12, 12))
		listeAllPiece.append(Piece(Piece13, 13))
		listeAllPiece.append(Piece(Piece14, 14))
		listeAllPiece.append(Piece(Piece15, 15))
		listeAllPiece.append(Piece(Piece16, 16))
		listeAllPiece.append(Piece(Piece17, 17))
		listeAllPiece.append(Piece(Piece18, 18))
		listeAllPiece.append(Piece(Piece19, 19))
		listeAllPiece.append(Piece(Piece20, 20))
		listeAllPiece.append(Piece(Piece21, 21))
